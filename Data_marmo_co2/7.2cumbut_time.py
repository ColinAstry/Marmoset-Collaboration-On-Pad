...
#画出累积按键数correct_count、correct + wrong count、correct/c+w随时间变化的图
...
df['correct_fraction'] = df['correct_count'] / df['correct + wrong_count']
...
plot_filename = f"{file_name}_cumbut_vs_time.png"
